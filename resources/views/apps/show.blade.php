                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="buttons">
                                    <a clas="col-1" href="{{ route('app.edit', $data->id) }}"
                                        class="btn btn-primary">Edit</a>
                                    <form class="col-1" method="POST"
                                        action="{{ route('app.destroy', $data->id) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($developers as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-bold-500">
                                                <form
                                                    action="{{ route('app.developer.destroy', [$data->id, $value->user_registration_number]) }}"
                                                    method="post">
                                                    {{ method_field('DELETE') }}
                                                    {{ csrf_field() }}
                        ...
                        <form action="{{ route('app.developer.store', [$data->id]) }}" method="post"
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form action="{{ route('app.developer.store', [$data->id]) }}" method="post"
                                    ...
                                    <input class="form-control" type="text" name="app_id" value="{{ $data->id }}"
                                        hidden>
                                    <div class="form-group col-md-5">
                                        <label class="mt-3 mb-2" for="user_registration_number">Registration
                                            Number</label>
