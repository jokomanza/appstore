                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('version.store', $app->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" accept=".jpg, .png, .jpeg" name="icon_file" required autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label for="apk_file">APK</label>
                                        <input class="form-control" type="file" accept=".apk" name="apk_file" required autofocus>
                                    </div>
                                    <div class="form-group">
